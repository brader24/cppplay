...
// configuration step. It creates a namespace called `cppplay`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cppplay::cmake::project_name, cppplay::cmake::project_version) };
